...
**�������:**
����������� ����������� ������������� ������������ ��-����������� (LOCAL, CLOUD, BRING_YOUR_OWN_KEY) ����� UI �������� � ����������� ������������ ������ � URL � ���� ������.

**Backend:**
- **Flyway Migration V25:** ��������� ������� open_ai_api_key, open_ai_model, ollama_url, ollama_model � ������� user_preferences.
- **Preferences Module:** ��������� PreferencesEntity, PreferencesRequest � PreferencesResponse ��� ��������� ����� �����. ���������� ������� � PreferencesServiceImpl.
- **Provider Factory:** ������� LlmProviderFactory ��� ������������� ������ ���������� LlmProvider �� ������ �������� ������������.
- **OpenAI Integration:** ���������� OpenAiLlmProvider ��� ������ � GPT-4o (����� ��������� ���� ��� ���� ������������).
- **Ollama Improvement:** OllamaLlmProvider ������ ���������� URL � ������ �� �������� ������������, ��� �������� ������ � Docker (��������, http://careerpilot-ollama:11434).
- **Fallback Logic:** ����� ������ �������� �������� � FallbackLlmGenerator.

**Frontend:**
- **Settings UI:** �� �������� �������� ��������� ������������ ���� ����� ��� ������� ������ �� (API Key, URL, Model).
- **Validation:** ����� Zod ��������� ��� ��������� ����� ������������ �����.
- **I18n:** ��������� �������� ��� ����� �������� � Docker-���������.

**�����������:**
- **Backend Tests:** �������� ����� AiServiceImplTest (7 ������).
- **Frontend Build:** ������ 
pm run build ������ �������.
...
**Backend:**
- **Encryption Service:** ������ EncryptionConverter (JPA AttributeConverter), ������������ AES-256-CBC ��� ���������� ������. ������-���� �������� ����� ENCRYPTION_MASTER_KEY � ���������.
- **Entity:** ��������� @Convert ��������� � ���� openAiApiKey � PreferencesEntity.
- **Masking:** � PreferencesServiceImpl ����������� ������������ ����� (sk-...4a2b) ����� ��������� � DTO.
- **Security Logic:** � updatePreferences ��������� ������ �� ���������� ��������� ����� ������������� ���������. ���� ��������� ������ �������� ..., ��� ������������.

**Frontend:**
- **Settings UI:** ���� API ����� ������ ����� ������������ placeholder, ������������ � ���, ��� ���� ��������. ������������� ���� �� ������� ������������ ������� (type='password').
- **Form Handling:** � handlePrefsSubmit ������ ������ ������ ���������� ����� (������ ������ ��� ��������� ������������ ������������� ��������).
- **I18n:** ��������� ����� settings.apiKeySaved ��� ������������� ���������� �����.
