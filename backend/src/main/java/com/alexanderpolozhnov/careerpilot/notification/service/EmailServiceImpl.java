...
public class EmailServiceImpl implements EmailService {
    ...
    public void sendReminderEmail(String to, String title, String message) {
        log.info("---------------------------------------------------------");
        log.info("REMINDER EMAIL for: {}", to);
        ...
        try {
            ...
            log.info("Connecting to SMTP server and sending HTML reminder email...");
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p style="margin-bottom: 0;">Это автоматическое напоминание от CareerPilot AI. Вы можете отключить уведомления в настройках.</p>
                        </div>
                        <div class="footer">
                            <div class="footer-text">
                                &copy; 2026 CareerPilot AI. Intelligent career management.<br>
