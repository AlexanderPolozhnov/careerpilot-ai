...
VALUES ('a1c3fe11-8ec0-4ef7-9f21-42b98d57c105', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Engineering Manager', 'MIDDLE', 'Remote', 'REMOTE', 4500, 'People-oriented engineer driving hiring, mentorship and platform quality.', '2026-03-03 11:00:00+00', '2026-03-03 11:00:00+00')
...
VALUES
    ...
    ('b2df0f21-4b66-4605-87a7-48cf6d8fd208', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Sofia Horak - Engineering Manager', 'https://cdn.demo.dev/resumes/sofia-manager.pdf', 'Engineering Manager with a strong background in leading high-performing teams.', FALSE, '2026-03-06 09:45:00+00', '2026-03-06 09:45:00+00'),
    ('b2df0f21-4b66-4605-87a7-48cf6d8fd209', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Sofia Horak - Director of Engineering', 'https://cdn.demo.dev/resumes/sofia-director.pdf', 'Experienced Director of Engineering scaling up cloud infrastructure teams.', FALSE, '2026-03-07 09:45:00+00', '2026-03-07 09:45:00+00'),
    ('b2df0f21-4b66-4605-87a7-48cf6d8fd210', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Sofia Horak - VP of Engineering', 'https://cdn.demo.dev/resumes/sofia-vp.pdf', 'VP of Engineering focused on organizational structure, hiring, and culture.', FALSE, '2026-03-08 09:45:00+00', '2026-03-08 09:45:00+00'),
    ('b2df0f21-4b66-4605-87a7-48cf6d8fd211', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Sofia Horak - Technical Lead', 'https://cdn.demo.dev/resumes/sofia-tech-lead.pdf', 'Tech Lead bridging the gap between product requirements and technical implementation.', FALSE, '2026-03-09 09:45:00+00', '2026-03-09 09:45:00+00'),
    ('b2df0f21-4b66-4605-87a7-48cf6d8fd212', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Sofia Horak - Architect', 'https://cdn.demo.dev/resumes/sofia-architect.pdf', 'System Architect specialized in distributed systems and microservices design.', FALSE, '2026-03-10 09:45:00+00', '2026-03-10 09:45:00+00')
...
VALUES
    ...
    ('c3ef1021-266a-4b88-bd6f-d7f07e7ba306', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'Future Tech Corp', 'https://future.example.com', 'Future Tech Corp Description', 'Tech', 'LARGE', 'Berlin', 'https://linkedin.com', 'https://logo', '2026-03-10 08:20:00+00', '2026-03-10 08:20:00+00')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('18245671-9711-4b79-9cb2-a22ef6f7a806', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'f6b23451-2309-4f39-9c82-d8bc32f3a611', 'Task 6', 'Description 6', '2026-04-19 18:00:00+00', FALSE, 'HIGH', '2026-04-16 09:00:00+00', '2026-04-16 09:00:00+00'),
    ('18245671-9711-4b79-9cb2-a22ef6f7a807', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'f6b23451-2309-4f39-9c82-d8bc32f3a612', 'Task 7', 'Description 7', '2026-04-19 18:00:00+00', FALSE, 'HIGH', '2026-04-16 09:00:00+00', '2026-04-16 09:00:00+00'),
    ('18245671-9711-4b79-9cb2-a22ef6f7a808', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'f6b23451-2309-4f39-9c82-d8bc32f3a613', 'Task 8', 'Description 8', '2026-04-19 18:00:00+00', FALSE, 'HIGH', '2026-04-16 09:00:00+00', '2026-04-16 09:00:00+00'),
    ('18245671-9711-4b79-9cb2-a22ef6f7a809', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'f6b23451-2309-4f39-9c82-d8bc32f3a614', 'Task 9', 'Description 9', '2026-04-19 18:00:00+00', FALSE, 'HIGH', '2026-04-16 09:00:00+00', '2026-04-16 09:00:00+00'),
    ('18245671-9711-4b79-9cb2-a22ef6f7a810', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'f6b23451-2309-4f39-9c82-d8bc32f3a615', 'Task 10', 'Description 10', '2026-04-19 18:00:00+00', FALSE, 'HIGH', '2026-04-16 09:00:00+00', '2026-04-16 09:00:00+00')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ('29356781-a6a9-4b7d-8bb2-41bf53f3a905', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'HIRING_PIPELINE_SUMMARY', 'seed-hash-hiring-sofia-001', '{"scope":"monthly_hiring_metrics","month":"2026-04"}', '{"summary":"7 active applications in pipeline, 2 interviews this week, median response time 2.3 days."}', '2026-04-18 08:00:00+00', '2026-10-18 08:00:00+00'),
    ('29356781-a6a9-4b7d-8bb2-41bf53f3a906', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'RESUME_ANALYSIS', 'hash-6', '{}', '{}', '2026-04-11 11:00:00+00', '2026-10-11 11:00:00+00'),
    ('29356781-a6a9-4b7d-8bb2-41bf53f3a907', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'RESUME_ANALYSIS', 'hash-7', '{}', '{}', '2026-04-11 11:00:00+00', '2026-10-11 11:00:00+00'),
    ('29356781-a6a9-4b7d-8bb2-41bf53f3a908', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'RESUME_ANALYSIS', 'hash-8', '{}', '{}', '2026-04-11 11:00:00+00', '2026-10-11 11:00:00+00'),
    ('29356781-a6a9-4b7d-8bb2-41bf53f3a909', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'RESUME_ANALYSIS', 'hash-9', '{}', '{}', '2026-04-11 11:00:00+00', '2026-10-11 11:00:00+00'),
    ('29356781-a6a9-4b7d-8bb2-41bf53f3a910', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'RESUME_ANALYSIS', 'hash-10', '{}', '{}', '2026-04-11 11:00:00+00', '2026-10-11 11:00:00+00')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('3a467891-c9da-47e2-a8b1-32297f56ba06', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'IN_APP', 'Title 6', 'Message 6', 'SENT', '2026-04-16 09:05:00+00', '2026-04-16 09:00:00+00'),
    ('3a467891-c9da-47e2-a8b1-32297f56ba07', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'IN_APP', 'Title 7', 'Message 7', 'SENT', '2026-04-16 09:05:00+00', '2026-04-16 09:00:00+00'),
    ('3a467891-c9da-47e2-a8b1-32297f56ba08', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'IN_APP', 'Title 8', 'Message 8', 'SENT', '2026-04-16 09:05:00+00', '2026-04-16 09:00:00+00'),
    ('3a467891-c9da-47e2-a8b1-32297f56ba09', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'IN_APP', 'Title 9', 'Message 9', 'SENT', '2026-04-16 09:05:00+00', '2026-04-16 09:00:00+00'),
    ('3a467891-c9da-47e2-a8b1-32297f56ba10', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'IN_APP', 'Title 10', 'Message 10', 'SENT', '2026-04-16 09:05:00+00', '2026-04-16 09:00:00+00')
ON CONFLICT (id) DO NOTHING;
...
VALUES
    ...
    ('4b5789a1-d0eb-4b31-9222-9ea87167cb06', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'ACTION_6', 'RESUME', 'b2df0f21-4b66-4605-87a7-48cf6d8fd201', '{}', '2026-01-11 10:01:00+00'),
    ('4b5789a1-d0eb-4b31-9222-9ea87167cb07', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'ACTION_7', 'RESUME', 'b2df0f21-4b66-4605-87a7-48cf6d8fd201', '{}', '2026-01-11 10:01:00+00'),
    ('4b5789a1-d0eb-4b31-9222-9ea87167cb08', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'ACTION_8', 'RESUME', 'b2df0f21-4b66-4605-87a7-48cf6d8fd201', '{}', '2026-01-11 10:01:00+00'),
    ('4b5789a1-d0eb-4b31-9222-9ea87167cb09', 'f0d3be01-6dc1-4e11-8b78-52a2f7b9a005', 'ACTION_9', 'RESUME', 'b2df0f21-4b66-4605-87a7-48cf6d8fd201', '{}', '2026-01-11 10:01:00+00')
ON CONFLICT (id) DO NOTHING;
