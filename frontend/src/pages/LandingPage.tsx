    ...
    return (
        <div className="min-h-dvh bg-[#08080a] text-[#e8eaed] overflow-x-hidden">
            ...
            <main>
                {/* Hero Section */}
                <section
                    className="relative min-h-[100vh] flex items-center justify-center pt-16 pb-20 px-5 overflow-hidden">
                    {/* Background Effects */}
                    <div className="absolute inset-0">
                        {/* Large gradient orb */}
                        <div
                            className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-violet-500/15 rounded-full blur-[150px] animate-pulse"/>
                        <div
                            className="absolute top-1/3 left-1/3 w-[400px] h-[400px] bg-purple-600/10 rounded-full blur-[120px] animate-pulse"
                            style={{animationDelay: '1s'}}/>
                        <div
                            className="absolute bottom-1/4 right-1/4 w-[300px] h-[300px] bg-violet-400/10 rounded-full blur-[100px] animate-pulse"
              ...
              <span className="relative flex h-2 w-2">
                ...
                <span className="relative inline-flex rounded-full h-2 w-2 bg-violet-500"/>
                        ...
                        >
                            ...
                            <span
                                className="bg-gradient-to-r from-violet-400 via-violet-500 to-purple-500 bg-clip-text text-transparent">{t('landing.hero.titleAccent')}</span>
                        </h1>
                        ...
                        >
                            <div className="relative mx-auto max-w-3xl">
                                {/* Glow effect */}
                                <div
                                    className="absolute -inset-4 bg-gradient-to-r from-violet-500/20 via-purple-500/20 to-violet-500/20 rounded-3xl blur-xl opacity-50"/>

                                {/* Mock UI Card */}
                                <div
                                    className="relative bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)] rounded-2xl p-1 backdrop-blur-sm">
                                    {/* Window chrome */}
                                    <div
                                        ...
                                        <div className="flex-1 flex justify-center">
                                            <div
                                                className="px-4 py-1 bg-[rgba(255,255,255,0.05)] rounded-md text-xs text-[#6b7590]">app.careerpilot.ai
                                            </div>
                                        </div>
                                        <div className="w-12"/>
                                    </div>
                                            ...
                                            {[
                                                ...
                                                <div key={i}
                                                    ...
                                                    <div className={`text-2xl font-bold text-${stat.color}-400`}
                                                         style={{fontFamily: 'Onest, system-ui, sans-serif'}}>{stat.value}</div>
                                        ...
                                        <div className="grid grid-cols-3 gap-3">
                                            {['Applied', 'Interview', 'Offer'].map((col, i) => (
                                                <div key={i} className="space-y-2">
                                                    ...
                                                    {[1, 2].map((card) => (
                                                        <div key={card}
                                                             className="p-3 bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.05)] rounded-lg">
                                                            <div
                                                                className="h-2 w-3/4 bg-[rgba(255,255,255,0.1)] rounded"/>
                                                            <div
                                                                className="h-2 w-1/2 bg-[rgba(255,255,255,0.05)] rounded mt-2"/>
                                                        </div>
                                                    ))}
                                                </div>
                                            ))}
              ...
              <span
                        ...
                        <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {featureCards.map((feature, index) => (
                                ...
                                >
                                    {/* Top accent line */}
                                    <div
                                        className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-violet-500/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"/>

                                    {/* Icon */}
                                    <div
                                        className="relative w-12 h-12 flex items-center justify-center rounded-xl bg-gradient-to-br from-violet-500/20 to-purple-600/20 border border-violet-500/25 shadow-lg shadow-violet-500/10 group-hover:shadow-violet-500/25 transition-all duration-500 group-hover:scale-110">
                                        {index === 0 && (
                                            <svg className="w-5 h-5 text-violet-400" fill="none" viewBox="0 0 24 24"
                                    ...
                                    {/* Content */}
                                    <h3 className="mt-5 text-[17px] font-semibold text-[#e8eaed] tracking-tight"
                                        style={{fontFamily: 'Onest, system-ui, sans-serif'}}>
                                    ...
                                    <div
                                        className="mt-4 flex items-center gap-1.5 text-violet-400 text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                ...
                >
                    {/* Background */}
                    <div
                        className="absolute inset-0 bg-gradient-to-b from-transparent via-[rgba(139,92,246,0.03)] to-transparent"/>
                ...
                {t('howItWorks.label')}
                                ...
                                {howItWorksSteps.map((step, index) => (
                                    ...
                                    >
                                        ...
                                        <div className="relative inline-flex">
                                            <div
                                                className="w-16 h-16 rounded-2xl bg-gradient-to-br from-violet-500/20 to-purple-600/20 border border-violet-500/30 flex items-center justify-center shadow-xl shadow-violet-500/10">
                        <span className="text-2xl font-bold text-violet-400"
                          ...
                          0{step}
                                            ...
                                            {/* Pulse ring */}
                                            <div
                                                className="absolute inset-0 rounded-2xl border border-violet-500/20 animate-ping opacity-20"
                                                style={{animationDuration: '2s'}}/>
                                        </div>

                                        <h3 className="mt-6 text-xl font-semibold text-[#e8eaed]"
                                            style={{fontFamily: 'Onest, system-ui, sans-serif'}}>
                ...
                >
                    <div className="relative max-w-4xl mx-auto">
                        ...
                        <div
                            ...
                            {/* Decorative elements */}
                            <div
                                className="absolute top-0 right-0 w-80 h-80 bg-violet-500/10 rounded-full blur-[100px]"/>
                            <div
            ...
            <footer className="relative border-t border-[rgba(255,255,255,0.06)]">
                <div
                    className="mx-auto max-w-6xl px-5 md:px-8 py-8 flex flex-col md:flex-row gap-4 md:items-center md:justify-between">
                    {/* Logo */}
                    <div className="flex items-center gap-2">
                        <div
                            className="w-7 h-7 rounded-lg bg-gradient-to-br from-violet-500 to-violet-600 flex items-center justify-center">
