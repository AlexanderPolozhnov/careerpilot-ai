...
export default function VacanciesPage() {
    ...
    return (
        <section className="space-y-4">
            ...
            <FilterBar
                left={<SearchBar value={query} onValueChange={setQuery}
                ...
                <>
                    {view === 'list' ? (
                        ...
                        <div className="card overflow-hidden">
                            <div
                                className="grid grid-cols-12 gap-3 px-4 py-3 text-xs text-ink-dim border-b border-border">
                                ...
                                {visibleItems.map((v) => (
                                    ...
                                    >
                                        <div className="col-span-5 min-w-0">
                                            ...
                                            <div
                                                className="text-xs text-ink-dim mt-1 truncate">{v.location ?? '—'} · {v.remote}</div>
                                        </div>
                                        <div
                                            className="col-span-3 text-sm text-ink-muted truncate">{v.company?.name ?? '—'}</div>
