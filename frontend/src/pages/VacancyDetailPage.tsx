      ...
      {vacancyQuery.isLoading ? (
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-5">
            {/* Header card */}
            <div className="relative p-6 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-2xl overflow-hidden">
              {/* Gradient accent */}
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-4 min-w-0">
                  {/* Company avatar */}
                  <div className="w-14 h-14 flex items-center justify-center rounded-xl bg-gradient-to-br from-violet-500/20 via-violet-500/10 to-purple-600/20 border border-violet-500/25 text-violet-400 shrink-0">
                    <BuildingIcon className="w-6 h-6" />
                  </div>
                  
                  <div className="min-w-0">
                    <h1 className="text-xl font-semibold text-[#e8eaed] mb-1" style={{ fontFamily: 'Onest, system-ui, sans-serif' }}>
                      {vacancy.title}
                    </h1>
                    ...
                    <div className="mt-4 flex flex-wrap items-center gap-2">
                      ...
                      {vacancy.tags.map((tag) => (
                        <span key={tag.id} className="px-2.5 py-1 text-xs font-medium text-[#8b8fa3] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)] rounded-full">
                          {tag.label}
                        </span>
                      ))}
                    </div>
            ...
            {vacancy.description && (
              <div className="p-6 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-xl">
                <h2 className="text-[14px] font-semibold text-[#e8eaed] mb-3" style={{ fontFamily: 'Onest, system-ui, sans-serif' }}>
            ...
            {company && (
              <div className="p-6 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-xl">
                <h2 className="text-[14px] font-semibold text-[#e8eaed] mb-4" style={{ fontFamily: 'Onest, system-ui, sans-serif' }}>
                  {t('vacancies.companyLabel')}
                </h2>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] text-[#6b7590]">
                    <BuildingIcon className="w-5 h-5" />
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="text-[15px] font-medium text-[#e8eaed] mb-1">{company.name}</div>
                    {company.description && (
                      <p className="text-[13px] text-[#6b7590] leading-relaxed mb-3">{company.description}</p>
                    )}
                    <div className="flex flex-wrap gap-2">
                      {company.industry && (
                        <span className="px-2.5 py-1 text-xs font-medium text-[#8b8fa3] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)] rounded-full">
                          {company.industry}
                        </span>
                      )}
                      {company.location && (
                        <span className="flex items-center gap-1 px-2.5 py-1 text-xs font-medium text-[#8b8fa3] bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)] rounded-full">
          ...
          <div className="space-y-5">
            {/* AI Analysis panel */}
            <div className="relative p-5 bg-gradient-to-br from-violet-500/10 via-[rgba(255,255,255,0.02)] to-purple-600/10 border border-violet-500/20 rounded-2xl overflow-hidden">
              {/* Decorative gradient */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-violet-500/10 rounded-full blur-3xl" />
              
              <div className="relative">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-9 h-9 flex items-center justify-center rounded-xl bg-gradient-to-br from-violet-500/30 to-purple-600/30 border border-violet-500/30 text-violet-400">
                    <SparklesIcon className="w-[18px] h-[18px]" />
                  </div>
                  <div>
                    <h2 className="text-[14px] font-semibold text-[#e8eaed]" style={{ fontFamily: 'Onest, system-ui, sans-serif' }}>
            ...
            {/* AI Insight result */}
            {aiInsight ? (
              <div className="p-5 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-xl">
                <AiInsightCard result={aiInsight} compact />
              </div>
            ) : (
              <div className="p-6 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-xl text-center">
                <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-[rgba(255,255,255,0.04)] text-[#4a4e5a] mx-auto mb-3">
            ...
            {/* Quick actions */}
            <div className="p-5 bg-[rgba(255,255,255,0.02)] border border-[rgba(255,255,255,0.06)] rounded-xl">
              <h3 className="text-[13px] font-semibold text-[#6b7590] uppercase tracking-wider mb-3">Quick Actions</h3>
